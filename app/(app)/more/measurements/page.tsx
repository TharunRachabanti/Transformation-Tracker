...
import { Ruler, Plus, TrendingDown, TrendingUp, Minus, ChevronLeft } from 'lucide-react'
    ...
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] font-medium text-slate-400 mt-0.5">Waist weekly · Others monthly</p>
        </div>
      </div>
